      ...
      <div className="flex h-screen overflow-hidden bg-slate-50">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="md:hidden flex items-center justify-between px-4 py-3 bg-white border-b border-slate-200">
            <button onClick={() => setMobileOpen(true)} className="flex flex-col gap-1.5 p-1"></button>
            <span className="block w-5 h-0.5 bg-slate-700 rounded" />
              <span className="block w-5 h-0.5 bg-slate-700 rounded" />
              <span className="block w-5 h-0.5 bg-slate-700 rounded" />
            </div>
            <span className="font-syne font-extrabold text-slate-900">
              Stag<span className="text-[#2E7DF7]">.</span>io
            </span>
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#5aaee8] to-[#2E7DF7] flex items-center justify-center text-xs font-bold text-white">
              AB
            </div>
          </div>
